(function ($) {
  ...
  if ($('.clients').length) {
	...
	gsap.set($(".hero-page__tittle h1 span"), {y: 120, opacity:0});					
	gsap.set($(".hero-page__text p"), {y: 30, opacity:0});  
	...
	gsap.to('.hero-page__text p', {duration: 0.7, y: 0, opacity:1, stagger:0.1, delay:1, ease:Power3.easeOut});
